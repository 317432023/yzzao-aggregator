 ...
 */
public class HttpJsonRequestEncoder extends AbstractHttpJsonEncoder<HttpObjectWrapRequest> {
    @Override
    protected void encode(ChannelHandlerContext ctx, HttpObjectWrapRequest msg, List<Object> out) throws Exception {
