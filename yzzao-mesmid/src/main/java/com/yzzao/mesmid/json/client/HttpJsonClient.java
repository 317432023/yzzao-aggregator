...
import com.yzzao.mesmid.json.codec.HttpJsonRequestEncoder;
import com.yzzao.mesmid.json.codec.HttpJsonResponseDecoder;
            ...
            b.group(group).channel(NioSocketChannel.class)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        public void initChannel(SocketChannel ch)
                            ...
                            // json解码器
                            ch.pipeline().addLast("json-decoder", new HttpJsonResponseDecoder(MESOrder.class, true));
